...
const NAMED_EXERCISES = {
  "ruba palla":    (ex) => buildDesc("Griglia 20×20 m. Un giocatore inizia come 'rubapalla' al centro.", "Tutti i giocatori conducono una palla all'interno della griglia. Il rubapalla (o i rubapalla) deve calciare fuori la palla degli avversari. Chi perde la palla si aggiunge ai rubapalla.", "Sviluppare protezione del pallone, corpo tra palla e avversario, cambi di direzione in spazio ridotto."),
  "la zona franca": (ex) => buildDesc("Campo 30×25 m diviso in zone. Zona franca al centro.", "Le squadre mantengono il possesso. Chi riesce a ricevere o condurre nella zona franca guadagna un punto. Vince chi raggiunge il punteggio obiettivo.", "Gestire gli spazi, trovare il varco nella zona centrale, sviluppare il terzo uomo."),
  "l' interspazio": (ex) => buildDesc("Campo 25×20 m. Due squadre di 4-6 giocatori.", "Il giocatore in possesso deve servire un compagno che riceve negli spazi tra le linee (interspazio). Punti assegnati solo per ricezione nell'interspazio con buona qualità di tocco.", "Sviluppare la ricerca e l'occupazione degli spazi interlinea, la visione periferica del portatore."),
  "i birilli":     (ex) => buildDesc("Area 20×10 m con birilli/cinesini. 1 giocatore per corsia.", "Il giocatore conduce il pallone nello slalom tra i birilli usando entrambi i piedi. Varianti: solo piede debole, cambio ritmo, conclusione finale.", "Migliorare il controllo della palla in conduzione, l'uso del piede debole e la coordinazione."),
  "il fosso":      (ex) => buildDesc("Due linee parallele separate da uno spazio ('fosso'). Giocatori su ogni lato.", "I giocatori si scambiano passaggi a due tocchi. Al segnale, uno attraversa il fosso per ricevere dall'altra parte. Chi sbaglia tocca e riparte.", "Migliorare la precisione del passaggio, il controllo orientato e il timing dei movimenti."),
  "le 11 porte":   (ex) => buildDesc("Campo grande (60×40 m) con 11 mini-porte distribuite. Due squadre.", "Si gioca a campo aperto. Si segna passando la palla a un compagno attraverso una qualsiasi delle 11 mini-porte. Cambiare spesso porta, sfruttare tutta l'ampiezza.", "Mobilità senza palla, utilizzo di tutto il campo, visione globale per trovare le porte libere."),
  "gremlin":       (ex) => buildDesc("Campo 30×20 m. Squadra in possesso vs 2-3 'gremlin' che pressano.", "I Gremlin non si possono muovere a caso: devono restare nella loro metà ma sono veloci nel pressing. La squadra in possesso mantiene la palla con tocchi limitati.", "Resistenza al pressing coordinato, velocità di circolazione, prendere le giuste decisioni sotto pressione."),
  "carlos santaba": (ex) => buildDesc("Metà campo. Due squadre + portieri.", "Lavoro di pressing con trigger codificati: al segnale dell'allenatore la squadra fuori palla scatta in pressing coordinato. Obiettivo: recuperare la palla entro 5 secondi.", "Pressing sincronizzato, comunicazione tra linee, trigger di riaggressione collettiva."),
  "cockatrice":    (ex) => buildDesc("Area di rigore + fascia. Vari attaccanti + portiere.", "Attacchi in serie: combinazione sulla fascia, appoggio a centrocampo, ripartenza in velocità e conclusione. Schema ripetuto da entrambi i lati.", "Automatizzare la fase di rifinitura, sviluppare la fluidità nelle combinazioni offensive in area."),
  "ranger":        (ex) => buildDesc("Campo largo. Due squadre di 6-8 giocatori.", "Possesso con la regola: ogni passaggio deve avanzare o cambiare lato. Vietato il passaggio indietro orizzontale nella propria metà. Il possesso senza avanzamento non conta.", "Verticalizzazione, velocità di gioco in avanzamento, sviluppare il coraggio di giocare in avanti."),
};
