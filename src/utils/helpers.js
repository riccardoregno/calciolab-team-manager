...
export function normalizeMatch(match){
  return {
    ...
    lineup: {
      ...
      viceCaptainId: match.lineup?.viceCaptainId || "",
      roles: match.lineup?.roles || {},
      shirtNumbers: match.lineup?.shirtNumbers || {},
...
export function getSetupProgress({
  ...
  const checks = [
    {
      key: "onboarding",
      labelKey: "common.setupChecks.onboarding",
    ...
    {
      key: "players",
      labelKey: "common.setupChecks.players",
    ...
    {
      key: "exercises",
      labelKey: "common.setupChecks.exercises",
    ...
    {
      key: "sessions",
      labelKey: "common.setupChecks.sessions",
    ...
    {
      key: "matches",
      labelKey: "common.setupChecks.matches",
